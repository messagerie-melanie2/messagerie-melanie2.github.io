...
`;
  ...
  class HTMLBnumInput extends BnumElementInternal {
       ...
       */
      enableButton({ text = undefined, icon = undefined, variation = exports.EButtonType.PRIMARY, } = {}) {
