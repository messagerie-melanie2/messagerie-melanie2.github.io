var Bnum = (function (exports) {
    ...
    ***************************************************************************** */
    ...
    function requireJsCircularEvent () {
    	...
    	const JsEvent = /*@__PURE__*/ requireJsEvent();
    ...
    function requireEvent () {
    	...
    	hasRequiredEvent = 1;
    	const JsEvent = /*@__PURE__*/ requireJsEvent();
    	const JsCircularEvent = /*@__PURE__*/ requireJsCircularEvent();
    ...
    var eventExports = /*@__PURE__*/ requireEvent();
    ...
    //#region Template
    const TEMPLATE$g = (h("div", { class: CLASS_WRAPPER, part: "container", children: [h("span", { class: CLASS_SLOT, children: h("slot", {}) }), h(HTMLBnumIcon, { hidden: "true", class: CLASS_ICON })] }));
    //#endregion Template
    ...
    let HTMLBnumRadio = (() => {
        let _classDecorators = [Define({
                template: TEMPLATE$d,
                tag: TAG_RADIO,
                styles: [INPUT_BASE_STYLE, style$h],
            })];
        let _classDescriptor;
        let _classExtraInitializers = [];
        let _classThis;
    ...
    let HTMLBnumSelect = (() => {
        let _classDecorators = [Define({
                tag: TAG_SELECT,
                template: TEMPLATE$c,
                styles: [INPUT_BASE_STYLE, style$g],
            }), UpdateAll()];
        let _classDescriptor;
        let _classExtraInitializers = [];
        let _classThis;
        ...
        (class extends _classSuper {
            ...
            static {
                ...
                _private__setFormValue_decorators = [Risky()];
                __fireSelect_decorators = [Autobind, Fire('change')];
                _static__p_observedAttributes_decorators = [NonStd('Deprecated')];
                __esDecorate(this, null, _static__p_observedAttributes_decorators, { kind: "method", name: "_p_observedAttributes", static: true, private: false, access: { has: obj => "_p_observedAttributes" in obj, get: obj => obj._p_observedAttributes }, metadata: _metadata }, null, _staticExtraInitializers);
                __esDecorate(this, _private__ui_descriptor = { get: __setFunctionName(function () { return this.#_ui_accessor_storage; }, "#_ui", "get"), set: __setFunctionName(function (value) { this.#_ui_accessor_storage = value; }, "#_ui", "set") }, _private__ui_decorators, { kind: "accessor", name: "#_ui", static: false, private: true, access: { has: obj => #_ui in obj, get: obj => obj.#_ui, set: (obj, value) => { obj.#_ui = value; } }, metadata: _metadata }, _private__ui_initializers, _private__ui_extraInitializers);
                __esDecorate(this, _private__legend_descriptor = { get: __setFunctionName(function () { return this.#_legend_accessor_storage; }, "#_legend", "get"), set: __setFunctionName(function (value) { this.#_legend_accessor_storage = value; }, "#_legend", "set") }, _private__legend_decorators, { kind: "accessor", name: "#_legend", static: false, private: true, access: { has: obj => #_legend in obj, get: obj => obj.#_legend, set: (obj, value) => { obj.#_legend = value; } }, metadata: _metadata }, _private__legend_initializers, _private__legend_extraInitializers);
                ...
                __esDecorate(this, null, __fireSelect_decorators, { kind: "method", name: "_fireSelect", static: false, private: false, access: { has: obj => "_fireSelect" in obj, get: obj => obj._fireSelect }, metadata: _metadata }, null, _instanceExtraInitializers);
                __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
                _classThis = _classDescriptor.value;
                if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
            }
            ...
            static Create({ label = null, options = [], defaults = null, hint = null, } = {}) {
                const node = document.createElement(this.TAG);
                if (!label)
                    node.setAttribute('no-legend', 'true');
                else
                    node.setAttribute('data-legend', label);
                if (hint)
                    node.setAttribute('data-hint', hint);
                if (defaults && defaults.text && defaults.value) {
                    node.setAttribute('data-default-text', defaults.text);
                    node.setAttribute('data-default-value', defaults.value);
                }
    ...
    let HTMLBnumSwitch = (() => {
        let _classDecorators = [Define({
                tag: 'bnum-switch',
                template: TEMPLATE$b,
                styles: [INPUT_BASE_STYLE, INPUT_STYLE_STATES, style$f],
            })];
        let _classDescriptor;
        let _classExtraInitializers = [];
        let _classThis;
     ...
     * @category Buttons
     */
    let HTMLBnumTertiaryButton = (() => {
        let _classDecorators = [Define({ tag: TAG_TERTIARY }), Variation(ButtonVariation.TERTIARY)];
        let _classDescriptor;
        let _classExtraInitializers = [];
        let _classThis;
        let _classSuper = HTMLBnumButton;
    ...
    let HTMLBnumCardItem = (() => {
        let _classDecorators = [Define({ tag: TAG_CARD_ITEM, styles: style$d, template: render(DEFAULT) }), UpdateAll(), Observe('disabled')];
        let _classDescriptor;
        let _classExtraInitializers = [];
        let _classThis;
        let _classSuper = BnumElementInternal;
    ...
    //#region Global Constants
    const SHEET$1 = HTMLBnumCardItem.ConstructCSSStyleSheet(style$c);
    ...
    //#endregion Types
    //#region Global Constants
    const SHEET = HTMLBnumCardItem.ConstructCSSStyleSheet(style$b);
    const EVENTS$2 = {
        CHANGED: {
    ...
    let HTMLBnumCardList = (() => {
        let _classDecorators = [Define({ tag: TAG_CARD_LIST, styles: style$a })];
        let _classDescriptor;
        let _classExtraInitializers = [];
        let _classThis;
        let _classSuper = BnumElement;
    ...
    let HTMLBnumCardTitle = (() => {
        let _classDecorators = [Define({ tag: TAG_CARD_TITLE, styles: style$9, template: TEMPLATE$8 }), UpdateAll(), Observe(ATTRIBUTE_URL)];
        let _classDescriptor;
        let _classExtraInitializers = [];
        let _classThis;
        let _classSuper = BnumElementInternal;
    ...
    var css_248z$8 = "@keyframes rotate360{0%{transform:rotate(0deg)}to{transform:rotate(1turn)}}:host{--_local-indent:calc(var(--bnum-folder-indentation-base, 0.5em)*var(--internal-bnum-folder-level, 0));display:var(--bnum-folder-display,block);padding-left:var(--bnum-folder-indentation,var(--_local-indent));width:var(--bnum-folder-width,100%)}:host .bal-container{display:flex;justify-content:space-between;padding:var(--bnum-folder-title-padding,10px 15px);transition:background-color .2s ease}:host .bal-container__left,:host .bal-container__title{align-content:center;align-items:center;display:flex;gap:var(--bnum-folder-gap,var(--bnum-space-s,10px))}:host .bal-container__title{width:calc(100% - 55px)}:host .bal-container__title__name{text-wrap:nowrap;max-width:none;overflow:hidden;text-overflow:ellipsis}:host .bal-container__title__icon{--bnum-icon-weight:var(--bnum-folder-icon-weight,300);--bnum-icon-opsz:var(--bnum-folder-icon-opsz,24);color:var(--bnum-folder-icon-color,inherit);flex-shrink:0}:host bnum-badge{font-size:12px;font-weight:700;height:calc(18px - var(--bnum-badge-padding, var(--bnum-space-xs, 5px))*2);transition:all .2s ease;width:calc(18px - var(--bnum-badge-padding, var(--bnum-space-xs, 5px))*2)}:host bnum-badge:state(no-value){display:none}:host([level=\"0\"]){border-bottom:var(--bnum-border-in-column)}:host([level=\"0\"]) .bal-container{font-weight:var(--bnum-font-weight-bold,bold);padding:var(--bnum-folder-bal-title-padding,15px 15px)}:host([level=\"0\"]) .bal-container__title__icon{display:none}:host([level=\"0\"]) .bal-container__left{justify-content:flex-end}:host(:state(no-subfolders)) .bal-container__toggle{display:none}:host(:state(double-digit-unread)) bnum-badge{font-size:var(--bnum-font-badge-s,.675rem)}:host(:state(triple-digit-unread)) bnum-badge{font-size:var(--bnum-font-badge-s,.675rem);height:calc(18px - var(--bnum-badge-padding, var(--bnum-space-xs, 5px))*2);width:calc(18px - var(--bnum-badge-padding, var(--bnum-space-xs, 5px))*2)}:host([is-collapsed=true]) .bal-sub-folders{display:none}:host([is-virtual=false]){cursor:pointer}:host([is-virtual=false]) .bal-container__title__name{pointer-events:all}:host([is-virtual=false]) .bal-container:hover{background-color:var(--bnum-color-list-hover)}:host(:focus),:host(:focus-visible){outline:none}:host([is-selected=true]) .bal-container{background-color:var(--bnum-color-list-active);cursor:default}:host([is-selected=true]) .bal-container:hover{background-color:var(--bnum-color-list-active)}:host(.dragover) .bal-container{background-color:var(--bnum-color-list-drag)}";
    var style$8 = css_248z$8;
     ...
     */
    let HTMLBnumFolder = (() => {
        let _classDecorators = [Define({ styles: style$8, template: TEMPLATE$7, tag: TAG_FOLDER }), Observe(ATTR_LABEL, ATTR_UNREAD, ATTR_ICON, ATTR_IS_COLLAPSED, ATTR_LEVEL, ATTR_IS_SELECTED)];
        let _classDescriptor;
        let _classExtraInitializers = [];
        let _classThis;
        let _classSuper = BnumElementInternal;
    ...
    let HTMLBnumRadioGroup = (() => {
        let _classDecorators = [Define({
                tag: TAG_RADIO_GROUP,
                template: TEMPLATE$6,
                styles: [INPUT_BASE_STYLE, style$7],
            })];
        let _classDescriptor;
        let _classExtraInitializers = [];
        let _classThis;
    ...
    let HTMLBnumCardAgenda = (() => {
        let _classDecorators = [Define({ tag: TAG_CARD_AGENDA, styles: style$3, template: TEMPLATE$2 }), Observe(ATTRIBUTE_LOADING$1)];
        let _classDescriptor;
        let _classExtraInitializers = [];
        let _classThis;
        let _classSuper = BnumElement;
    ...
    let HTMLBnumCardEmail = (() => {
        let _classDecorators = [Define({ tag: TAG_CARD_EMAIL, styles: style$2, template: TEMPLATE$1 }), Observe(ATTRIBUTE_LOADING)];
        let _classDescriptor;
        let _classExtraInitializers = [];
        let _classThis;
        let _classSuper = BnumElement;
     ...
     */
    let HTMLBnumHeader = (() => {
        let _classDecorators = [Define({ tag: TAG_HEADER, styles: style$1, template: TEMPLATE })];
        let _classDescriptor;
        let _classExtraInitializers = [];
        let _classThis;
        let _classSuper = BnumElementInternal;
    ...
    var css_248z = "@keyframes rotate360{0%{transform:rotate(0deg)}to{transform:rotate(1turn)}}bnum-tree{display:block}bnum-tree:focus{position:relative}";
    var style = css_248z;
    ...
    let HTMLBnumTree = (() => {
        ...
        (class extends _classSuper {
            ...
            static TryIncludeStyle() {
                const css = BnumElementInternal.ConstructCSSStyleSheet(style);
    ...
    exports.HTMLBnumAvatarAction = HTMLBnumAvatarAction;
    ...
    exports.HTMLBnumPlaceholder = HTMLBnumPlaceholder;
    ...
    exports.HTMLBnumTertiaryButton = HTMLBnumTertiaryButton;
    exports.HTMLBnumToggleButton = HTMLBnumToggleButton;
